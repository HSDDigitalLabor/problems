"""
Original source: https://github.com/cs50/problems/blob/af57cc6a46104e309acbb48f93e535e4c6eb8d69/interpreter/__init__.py
"""
...
def test_one_plus_one():
    ...
    input = "1 + 1"
    output = "2.0"
    check50.run("python3 interpreter.py").stdin(input, prompt=True).stdout(
